...
import FontSubset from './subset'
import PDFName from '../object/name'
import PDFObject from '../object/object'
import PDFDictionary from '../object/dictionary'
import PDFString from '../object/string'
import PDFArray from '../object/array'
import PDFStream from '../object/stream'
import Base from './base'
import { toArrayBuffer} from '../util'

const StringWidth = Base.StringWidth

export default class OTFFontFactory extends Base {
  constructor(b) {
    super()

    // convert to array buffer
    const ab = toArrayBuffer(b)
    this.font = parse(ab)
  }
