...
module.exports = class Fragment {
  ...
  text(text) {
    if (text) {
      this._doc._pending.push(() => renderText.call(this, text))
    }
  }
  ...
  cell(text, opts) {
    ...
    this._doc._pending.push(() => ctx._start(text, opts))
  ...
  startCell(opts) {
    ...
    this._doc._pending.push(() => ctx._start(null, opts))
  ...
  startRow(opts) {
    ...
    this._doc._pending.push(() => ctx._start(opts))
