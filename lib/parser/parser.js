...
export default class Parser {
  ...
  parse() {
    ...
    console.log(objects)
    this.xref    = PDFXref.parse.call(objects, null, lexer)
    this.trailer = this.xref.trailer || PDFTrailer.parse.call(objects, this.xref, lexer)

    let trailer = this.trailer
    while (trailer.has('Prev')) {
      lexer.pos = trailer.get('Prev')
      const xref = PDFXref.parse.call(objects, null, lexer)
      ...
      trailer = xref.trailer || PDFTrailer.parse.call(objects, xref, lexer)
    }
  }
