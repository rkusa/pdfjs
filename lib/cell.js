...
module.exports = class Cell extends Fragment {
  constructor(doc, parent, opts) {
    ...
    this.paddingTop    = opts.padding || opts.paddingTop    || 0
    this.paddingRight  = opts.padding || opts.paddingRight  || 0
    this.paddingBottom = opts.padding || opts.paddingBottom || 0
    this.paddingLeft   = opts.padding || opts.paddingLeft   || 0
