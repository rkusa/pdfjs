...
import {colorToRgb, rgbEqual} from './util'
import ops from './ops'

export default class Cell extends Fragment {
  ...
  async _createBackground(hasTopBorder, hasBottomBorder) {
    ...
    if (this._drawBorders) {
      ...
      if (this.borderLeftWidth > 0) {
        if (!borderColor || !rgbEqual(borderColor, this.borderLeftColor)) {
      ...
      if (this.borderRightWidth > 0) {
        if (!borderColor || !rgbEqual(borderColor, this.borderRightColor)) {
      ...
      if (hasTopBorder && this.borderTopWidth > 0) {
        if (!borderColor || !rgbEqual(borderColor, this.borderTopColor)) {
      ...
      if (hasBottomBorder && this.borderBottomWidth > 0) {
        if (!borderColor || !rgbEqual(borderColor, this.borderBottomColor)) {
...
function applyOpts(opts) {
  ...
  this.backgroundColor = colorToRgb(opts.backgroundColor)

  this.borderTopWidth = opts.borderTopWidth || opts.borderWidth || 0
  this.borderTopColor = colorToRgb(opts.borderTopColor || opts.borderColor || 0x000000)

  this.borderRightWidth = opts.borderRightWidth || opts.borderWidth || 0
  this.borderRightColor = colorToRgb(opts.borderRightColor || opts.borderColor || 0x000000)

  this.borderBottomWidth = opts.borderBottomWidth || opts.borderWidth || 0
  this.borderBottomColor = colorToRgb(opts.borderBottomColor || opts.borderColor || 0x000000)

  this.borderLeftWidth = opts.borderLeftWidth || opts.borderWidth || 0
  this.borderLeftColor = colorToRgb(opts.borderLeftColor || opts.borderColor || 0x000000)
