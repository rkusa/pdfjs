...
var PDFFormXObject = module.exports = function(id, img) {
  ...
  this.resources = img.info.page.get('Resources').object
  ...
  this.prop('Resources', this.resources.toReference())
  ...
  this.objects = [this.resources]
  this.addObjectsRecursive(this.resources)
}
