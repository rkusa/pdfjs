...
var Page = module.exports = function(doc, parent) {
  ...
  this.pageNumber = 1
  this.cursor     = doc.height - doc.padding.top
  this.area       = { header: null, footer: null }
  this.padding    = { top: doc.padding.top, right: doc.padding.right,
                    bottom: doc.padding.bottom, left: doc.padding.left }
