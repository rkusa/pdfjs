...
var Text = module.exports = function(style, opts) {
...
Text.prototype.addLineBreak = function() {
  this.children.push(new LineBreak(this.style))
  return this
}

Text.prototype.addPageNumber = function(opts) {
...
Text.prototype.addPageCount = function(opts) {
