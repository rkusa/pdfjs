  ...
  if (offset === null) {
    ...
    if (entry.compressed) {
      if (!entry.obj) {
        ...
        const obj = PDFObject.parse.call(this, xref, lexer)
      ...
      if (!inner.obj) {
        ...
        inner.obj = PDFObject.parseInner.call(this, xref, innerLexer)
      }
    ...
    lexer.pos = offset
    return PDFObject.parse.call(this, xref, lexer)
  }
}
