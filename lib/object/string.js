      ...
      switch (c) {
        ...
        case 0x5c: // \
          ...
          switch (c) {
            ...
            case 0x38: // 8
            case 0x39: // 9
              // octal may consist of one, two, or three octal digits
              let oct = String.fromCharCode(c);
              for (let i = 0; i < 2; ++i) {
                const a = lexer._nextCharCode();
                // check if its a numer
                if (a >= 0x30 && a <= 0x39) {
                  oct += String.fromCharCode(a);
                } else {
                  lexer.shift(-1);
                }
              }
