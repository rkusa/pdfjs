...
var box = doc.createBox({ borderWidth: 20, borderColor: 0xdddddd, backgroundColor: 0xeeeeee, width: '50%', padding: 10 })
var boxText = box.createText({ textAlign: 'justify' })
boxText.add(loremShort)
// boxText.add(lorem)
