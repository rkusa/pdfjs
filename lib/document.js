...
var Document = module.exports = function(font) {
  this.version = 1.7
...
Document.prototype.text = require('./content/text')
...
Document.prototype.createPages = function() {
  ...
  this.contents.forEach(function(content) {
    contents.push(content.prepare(self.innerWidth))
  })
  for (var i = 0; i < contents.length; ++i) {
    ...
    if (content.height > y - this.padding.bottom) {
      ...
      contents.splice(i + 1, 0, succ)
      content.render(page, y)
