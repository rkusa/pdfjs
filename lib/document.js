...
class Document extends Readable {
  ...
  addPagesOf(external) {
    ...
    Fragment.prototype._begin.call(this, null)
  ...
  text(text, opts) {
    return Fragment.prototype.text.call(this, text, opts)
  }

  cell(text, opts) {
    return Fragment.prototype.cell.call(this, text, opts)
  }

  table(opts) {
    return Fragment.prototype.table.call(this, opts)
  }

  image(img, opts) {
    Fragment.prototype.image.call(this, img, opts)
  }

  pageBreak() {
    Fragment.prototype.pageBreak.call(this)
  }

  op(fn) {
    Fragment.prototype.op.apply(this, arguments);
  }

  destination(name) {
    Fragment.prototype.destination.call(this, name);
  }
}
