module.exports = function (doc, { image, lorem }) {
  ...
  doc.outline(
    "4.1. Can have children",
    "Unknown",
    "4. Empty/Unknown destinations",
  );
  doc.outline(
    "4.2. But are not reactive",
    "Unknown",
    "4. Empty/Unknown destinations",
  );
  ...
  doc.outline(
    "6. An outline with an undefined parent is added to the root",
    "Text",
  );
  ...
  const firstSibling = doc.outline(
    "Sibling",
    "Text",
    "8. Outlines can have the same name (siblings)",
  );
  const secondSibling = doc.outline(
    "Sibling",
    "Doc",
    "8. Outlines can have the same name (siblings)",
  );
